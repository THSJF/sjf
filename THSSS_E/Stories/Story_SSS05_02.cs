...
// Type: Shooting.Planes.Story.Story_SSS05_02
...
{
  internal class Story_SSS05_02 : BaseStory_SSS
  {
    public Story_SSS05_02(StageDataPackage StageData)
      : base(StageData)
    {
      switch (this.MyPlane.Name)
      {
        case "Reimu":
          this.LoadConversation2(".\\Story\\5-2A.csv");
          break;
        case "Marisa":
          this.LoadConversation(".\\Story\\5-2B.csv");
          break;
        case "Sanae":
          this.LoadConversation(".\\Story\\5-2C.csv");
          break;
        case "Koishi":
          this.LoadConversation(".\\Story\\5-2D.csv");
          break;
      }
    }
    ...
    public override void Ctrl()
    {
      ...
      if (this.Time == this.NameTime && this.LastTime < this.Time)
      {
        ...
        this.CharN = new CharacterName(this.StageData, "ename_Rakukun");
      ...
      {
        this.StageData.ChangeBGM(".\\BGM\\Boss05.wav", 0, 0, (int) byte.MaxValue, 1000056, 6599345);
        this.LastTime = this.Time;
      }
      if (this.Time != this.Conv.Count)
        return;
      MusicTitle musicTitle = new MusicTitle(this.StageData, "引燃夜空的星火", new Point(this.BoundRect.Width, this.BoundRect.Height - 16));

...
// Type: Shooting.Planes.Story.Story_SSS01_01A
...
{
  internal class Story_SSS01_01A : BaseStory_SSS
  {
    public Story_SSS01_01A(StageDataPackage StageData)
      : base(StageData)
    {
      this.LoadConversation2(".\\Story\\1-1A.csv");
    }

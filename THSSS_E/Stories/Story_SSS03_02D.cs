...
// Type: Shooting.Planes.Story.Story_SSS03_02D
...
{
  internal class Story_SSS03_02D : BaseStory_SSS
  {
    public Story_SSS03_02D(StageDataPackage StageData)
      : base(StageData)
    {
      this.LoadConversation(".\\Story\\3-2D.csv");
    }

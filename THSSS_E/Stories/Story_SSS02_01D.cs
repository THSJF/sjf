...
// Type: Shooting.Planes.Story.Story_SSS02_01D
...
{
  internal class Story_SSS02_01D : BaseStory_SSS
  {
    public Story_SSS02_01D(StageDataPackage StageData)
      : base(StageData)
    {
      this.LoadConversation(".\\Story\\2-1D.csv");
    }

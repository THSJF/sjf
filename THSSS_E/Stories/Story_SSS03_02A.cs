...
// Type: Shooting.Planes.Story.Story_SSS03_02A
...
{
  internal class Story_SSS03_02A : BaseStory_SSS
  {
    public Story_SSS03_02A(StageDataPackage StageData)
      : base(StageData)
    {
      this.LoadConversation2(".\\Story\\3-2A.csv");
    }

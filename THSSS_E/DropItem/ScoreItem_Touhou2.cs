...
// Type: Shooting.ScoreItem_Touhou2
...
namespace Shooting
{
  internal class ScoreItem_Touhou2 : BaseItem_Touhou
  {
    public ScoreItem_Touhou2(StageDataPackage StageData, PointF OriginalPosition)
      : base(StageData, "Item-7", OriginalPosition)
    {
      this.Region = 5;

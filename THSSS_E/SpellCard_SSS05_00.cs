...
// Type: Shooting.SpellCard_SSS05_00
...
namespace Shooting
{
  internal class SpellCard_SSS05_00 : BaseSpellCard
  {
    public SpellCard_SSS05_00(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "杀箭「新星爆炸箭」";
      else
        this.SC_Name = "杀箭「新星爆炸箭」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St05\\道中Boss\\1符E.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St05\\道中Boss\\1符N.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St05\\道中Boss\\1符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St05\\道中Boss\\1符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St05\\道中Boss\\1符L.mbg";
          break;

...
namespace Shooting
{
  internal class Boss_Seiryuu02 : BaseBossTouhou
  {
    public Boss_Seiryuu02(StageDataPackage StageData)
      : base(StageData)
    {
    ...
    private void Ctrl1()
    {
      ...
      else
      {
        ...
        if (this.Time == 2)
        {
          SpellCard_SSS03_FSC spellCardSsS03Fsc = new SpellCard_SSS03_FSC(this.StageData);
        }
      }
    }

...
// Type: Shooting.SpellCard_SSS05_03
...
namespace Shooting
{
  internal class SpellCard_SSS05_03 : BaseSpellCard
  {
    public SpellCard_SSS05_03(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "混沌「守护的心意」";
      else
        this.SC_Name = "混沌「守护之心」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St05\\关底Boss\\3符E.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St05\\关底Boss\\3符N.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St05\\关底Boss\\3符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St05\\关底Boss\\3符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St05\\关底Boss\\3符L.mbg";
          break;

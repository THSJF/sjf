    ...
    public override void ProcessZ()
    {
      ...
      switch (this.MenuItemList[this.MenuSelectIndex].Name)
      {
        case "Stage01":
          ...
          break;
        case "Stage02":
          this.StageData.StateSwitchData.SDPswitch.MyPlane.Power = 300;
          this.StageData.Rep.CreatRpy();
          this.StageData.StateSwitchData.NextState = "St2";
          this.StageData.StateSwitchData.SDPswitch.SetReplayInfo(this.StageData.StateSwitchData.NextState);
          break;
        case "Stage03":
          this.StageData.StateSwitchData.SDPswitch.MyPlane.Power = 400;
          this.StageData.Rep.CreatRpy();
        ...
        case "Stage06":
          ...
          break;
        case "Boss01":
          this.StageData.StateSwitchData.SDPswitch.MyPlane.Power = 200;
          this.StageData.Rep.CreatRpy();

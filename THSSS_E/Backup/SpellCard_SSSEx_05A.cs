...
// Type: Shooting.SpellCard_SSSEx_05A
...
namespace Shooting
{
  internal class SpellCard_SSSEx_05A : BaseSpellCard
  {
    public SpellCard_SSSEx_05A(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "飓风「台风眼」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\5符0.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSS03_04
...
namespace Shooting
{
  internal class SpellCard_SSS03_04 : BaseSpellCard
  {
      ...
      if (this.Time == 150)
      {
        ...
        switch (this.Difficulty)
        {
          case DifficultLevel.Easy:
            FileName = ".\\CS\\St03\\关底Boss\\2符E.mbg";
            break;
          case DifficultLevel.Normal:
            FileName = ".\\CS\\St03\\关底Boss\\2符N.mbg";
            break;
          case DifficultLevel.Hard:
            FileName = ".\\CS\\St03\\关底Boss\\2符H.mbg";
            break;
          case DifficultLevel.Lunatic:
            FileName = ".\\CS\\St03\\关底Boss\\2符L.mbg";
            break;
          default:
            FileName = ".\\CS\\St03\\关底Boss\\2符U.mbg";
            break;
        }

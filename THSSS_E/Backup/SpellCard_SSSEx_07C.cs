...
// Type: Shooting.SpellCard_SSSEx_07C
...
namespace Shooting
{
  internal class SpellCard_SSSEx_07C : BaseSpellCard
  {
    public SpellCard_SSSEx_07C(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "「雾隐流剑技 ～ 落雪凝霜」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\7符2.mbg"));
    }
  }
}

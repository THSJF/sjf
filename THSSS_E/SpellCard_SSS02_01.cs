...
// Type: Shooting.SpellCard_SSS02_01
...
namespace Shooting
{
  internal class SpellCard_SSS02_01 : BaseSpellCard
  {
    public SpellCard_SSS02_01(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "魔矢「无限之箭」";
      else
        this.SC_Name = "魔矢「轮回的万箭」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St02\\道中Boss\\1符E.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St02\\道中Boss\\1符N.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St02\\道中Boss\\1符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St02\\道中Boss\\1符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St02\\道中Boss\\1符L.mbg";
          break;

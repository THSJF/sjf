...
namespace Shooting
{
  public class MyPlane_AyaB : BaseMyPlane_Touhou
  {
    public MyPlane_AyaB(StageDataPackage StageData, Point OriginalPosition)
      : base(StageData, OriginalPosition, "Aya")
    {
      this.WeaponType = "B";
      this.SubPlaneList = new List<BaseSubPlane>()
      {
        (BaseSubPlane) new SubPlane_AyaB(StageData, this.Position),
        (BaseSubPlane) new SubPlane_AyaB(StageData, this.Position),
        (BaseSubPlane) new SubPlane_AyaB(StageData, this.Position),
        (BaseSubPlane) new SubPlane_AyaB(StageData, this.Position)
      };
    ...
    {
      Spell_AyaB spellAyaB = new Spell_AyaB(this.StageData);
      ...
      else
      {
        switch (this.PowerLevel)
        {
          ...
          case 2:
            ...
            double num18 = (double) this.OriginalPosition.X - 30.0;
            ...
            double num20 = (double) originalPosition4.X + 30.0;
            originalPosition4 = this.OriginalPosition;
            double num21 = (double) originalPosition4.Y - 0.0;
            PointF pointF11 = new PointF((float) num20, (float) num21);
            local11 = pointF11;
            this.SubPlaneList[0].ShootDirection = -1.8207963267949;
            this.SubPlaneList[1].ShootDirection = -1.3207963267949;
            break;
          case 3:
            ...
            double num23 = (double) originalPosition5.X - 25.0;
            originalPosition5 = this.OriginalPosition;
            ...
            originalPosition5 = this.OriginalPosition;
            double num25 = (double) originalPosition5.X + 25.0;
            originalPosition5 = this.OriginalPosition;
          ...
          case 4:
            ...
            double num27 = (double) this.OriginalPosition.X - 15.0;
            PointF originalPosition6 = this.OriginalPosition;
            double num28 = (double) originalPosition6.Y + 26.0;
            ...
            double num29 = (double) originalPosition6.X + 15.0;
            originalPosition6 = this.OriginalPosition;
            double num30 = (double) originalPosition6.Y + 26.0;
            PointF pointF16 = new PointF((float) num29, (float) num30);
            local16 = pointF16;
            ref PointF local17 = ref this.SubPlanePoint[2];
            originalPosition6 = this.OriginalPosition;
            double num31 = (double) originalPosition6.X - 30.0;
            originalPosition6 = this.OriginalPosition;
            double num32 = (double) originalPosition6.Y + 15.0;
            PointF pointF17 = new PointF((float) num31, (float) num32);
            local17 = pointF17;
            ref PointF local18 = ref this.SubPlanePoint[3];
            originalPosition6 = this.OriginalPosition;
            double num33 = (double) originalPosition6.X + 30.0;
            originalPosition6 = this.OriginalPosition;
            double num34 = (double) originalPosition6.Y + 15.0;

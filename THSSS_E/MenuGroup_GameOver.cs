      ...
      switch (this.MenuItemList[this.MenuSelectIndex].Name)
      {
        ...
        case "Menu_从头开始":
          ...
          if (index >= 0) {
                        ...
                        //    baseMyPlane.LifeUpCount=repInfo.MyPlaneData[index].LifeUpCount;
                        //    baseMyPlane.Life=repInfo.MyPlaneData[index].Life;
                        //     baseMyPlane.LifeChip=repInfo.MyPlaneData[index].LifeChip;
                        //     baseMyPlane.Spell=repInfo.MyPlaneData[index].Spell;
                        //     baseMyPlane.SpellChip=repInfo.MyPlaneData[index].SpellChip;
                        //      baseMyPlane.Power=repInfo.MyPlaneData[index].Power;
                        //      baseMyPlane.Score=repInfo.MyPlaneData[index].Score;
                        //      baseMyPlane.HighItemScore=repInfo.MyPlaneData[index].HighItemScore;
                        //      baseMyPlane.StarPoint=repInfo.MyPlaneData[index].StarPoint;
                        //      baseMyPlane.LastColor=repInfo.MyPlaneData[index].LastColor;

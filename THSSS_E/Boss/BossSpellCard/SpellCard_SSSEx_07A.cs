...
// Type: Shooting.SpellCard_SSSEx_07A
...
namespace Shooting
{
  internal class SpellCard_SSSEx_07A : BaseSpellCard
  {
    public SpellCard_SSSEx_07A(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "「雾隐流剑技 ～ 暴风疾斩」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\7符0.mbg"));
    }
  }
}

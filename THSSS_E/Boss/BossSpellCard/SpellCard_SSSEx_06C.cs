...
// Type: Shooting.SpellCard_SSSEx_06C
...
namespace Shooting
{
  internal class SpellCard_SSSEx_06C : BaseSpellCard
  {
    public SpellCard_SSSEx_06C(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "雪幕「冰雪流凌」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\6符2.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSSEx_06B
...
namespace Shooting
{
  internal class SpellCard_SSSEx_06B : BaseSpellCard
  {
    public SpellCard_SSSEx_06B(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "花符「云上的花田」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\6符1.mbg"));
    }
  }
}

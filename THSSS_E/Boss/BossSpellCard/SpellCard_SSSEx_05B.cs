...
// Type: Shooting.SpellCard_SSSEx_05B
...
namespace Shooting
{
  internal class SpellCard_SSSEx_05B : BaseSpellCard
  {
    public SpellCard_SSSEx_05B(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "花咲「百花缭乱」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\5符1.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSSEx_02C
...
namespace Shooting
{
  internal class SpellCard_SSSEx_02C : BaseSpellCard
  {
    public SpellCard_SSSEx_02C(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "仙器「太乙冰凌」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\2符2.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSS04_02D
...
namespace Shooting
{
  internal class SpellCard_SSS04_02D : BaseSpellCard
  {
    public SpellCard_SSS04_02D(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "镜符「若竹色翠石裂隙」";
      else
        this.SC_Name = "镜符「若竹色翠石裂隙」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St04\\关底Boss\\2符E3.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St04\\关底Boss\\2符N3.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St04\\关底Boss\\2符H3.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St04\\关底Boss\\2符L3.mbg";
          break;
        default:
          FileName = ".\\CS\\St04\\关底Boss\\2符U3.mbg";
          break;
      }

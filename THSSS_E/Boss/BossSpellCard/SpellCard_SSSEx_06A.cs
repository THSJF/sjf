...
// Type: Shooting.SpellCard_SSSEx_06A
...
namespace Shooting
{
  internal class SpellCard_SSSEx_06A : BaseSpellCard
  {
    public SpellCard_SSSEx_06A(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "天岚「逆卷神风」";
      this.BaseScore = 40000000L;
      this.Boss.DestPoint = (PointF) new Point(this.BoundRect.Width / 2, 192);
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\6符0.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSS04_02C
...
namespace Shooting
{
  internal class SpellCard_SSS04_02C : BaseSpellCard
  {
    public SpellCard_SSS04_02C(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "镜符「瑠璃色银河裂隙」";
      else
        this.SC_Name = "镜符「瑠璃色银河裂隙」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St04\\关底Boss\\2符E2.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St04\\关底Boss\\2符N2.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St04\\关底Boss\\2符H2.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St04\\关底Boss\\2符L2.mbg";
          break;
        default:
          FileName = ".\\CS\\St04\\关底Boss\\2符U2.mbg";
          break;
      }

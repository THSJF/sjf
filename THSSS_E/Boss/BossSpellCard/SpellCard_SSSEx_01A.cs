...
// Type: Shooting.SpellCard_SSSEx_01A
...
namespace Shooting
{
  internal class SpellCard_SSSEx_01A : BaseSpellCard
  {
    public SpellCard_SSSEx_01A(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "风符「环形气流」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\1符0.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSSEx_03B
...
namespace Shooting
{
  internal class SpellCard_SSSEx_03B : BaseSpellCard
  {
    public SpellCard_SSSEx_03B(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "萱草「忘却之爱」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\3符1.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSS04_04A
...
namespace Shooting
{
  internal class SpellCard_SSS04_04A : BaseTimeSC
  {
    public SpellCard_SSS04_04A(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "辉针「闪耀万针剑」";
      else
        this.SC_Name = "辉针「闪耀万针剑」";
      ...
      if (this.Time == 150)
      {
        ...
        switch (this.Difficulty)
        {
          case DifficultLevel.Easy:
            FileName = ".\\CS\\St04\\关底Boss\\4符E0.mbg";
            break;
          case DifficultLevel.Normal:
            FileName = ".\\CS\\St04\\关底Boss\\4符N0.mbg";
            break;
          case DifficultLevel.Hard:
            FileName = ".\\CS\\St04\\关底Boss\\4符H0.mbg";
            break;
          case DifficultLevel.Lunatic:
            FileName = ".\\CS\\St04\\关底Boss\\4符L0.mbg";
            break;
          default:
            FileName = ".\\CS\\St04\\关底Boss\\4符U0.mbg";
            break;
        }

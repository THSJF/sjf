...
// Type: Shooting.SpellCard_SSS02_03
...
namespace Shooting
{
  internal class SpellCard_SSS02_03 : BaseSpellCard
  {
    ...
    {
      this.Boss.Armon = 0.8f;
      if (this.Time > 100)
        this.Boss.RandomMove1(180, 1.2f);
      if (this.Time != 150)
        return;
      string FileName;
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St02\\关底Boss\\2符E.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St02\\关底Boss\\2符N.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St02\\关底Boss\\2符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St02\\关底Boss\\2符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St02\\关底Boss\\2符L.mbg";
          break;

...
// Type: Shooting.SpellCard_SSS04_02B
...
namespace Shooting
{
  internal class SpellCard_SSS04_02B : BaseSpellCard
  {
    public SpellCard_SSS04_02B(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "镜符「山吹色波纹裂隙」";
      else
        this.SC_Name = "镜符「山吹色波纹裂隙」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St04\\关底Boss\\2符E1.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St04\\关底Boss\\2符N1.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St04\\关底Boss\\2符H1.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St04\\关底Boss\\2符L1.mbg";
          break;
        default:
          FileName = ".\\CS\\St04\\关底Boss\\2符U1.mbg";
          break;
      }

...
// Type: Shooting.SpellCard_SSSEx_03D
...
namespace Shooting
{
  internal class SpellCard_SSSEx_03D : BaseSpellCard
  {
    public SpellCard_SSSEx_03D(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "倒映「天之月水之月」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\3符3.mbg"));
    }
  }
}

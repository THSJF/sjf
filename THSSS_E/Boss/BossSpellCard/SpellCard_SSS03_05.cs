...
// Type: Shooting.SpellCard_SSS03_05
...
namespace Shooting
{
  internal class SpellCard_SSS03_05 : BaseSpellCard
  {
    public SpellCard_SSS03_05(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "绿符「柳叶风暴」";
      else
        this.SC_Name = "深绿「舞动的翠绿之风」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St03\\关底Boss\\3符E.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St03\\关底Boss\\3符N.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St03\\关底Boss\\3符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St03\\关底Boss\\3符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St03\\关底Boss\\3符U.mbg";
          break;
      }

...
// Type: Shooting.SpellCard_SSSEx_09
...
namespace Shooting
{
  internal class SpellCard_SSSEx_09 : BaseTimeSC
  {
    public SpellCard_SSSEx_09(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "仙蝶「无限的彩灵」";
      this.BaseScore = 40000000L;
      this.Boss.DestPoint = (PointF) new Point(this.BoundRect.Width / 2, -150);
    ...
    {
      this.Boss.Armon = this.Boss.ArmonArray[16];
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\9符.mbg"));
    }
  }
}

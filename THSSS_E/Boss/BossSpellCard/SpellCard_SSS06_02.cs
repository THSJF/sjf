...
// Type: Shooting.SpellCard_SSS06_02
...
namespace Shooting
{
  internal class SpellCard_SSS06_02 : BaseSpellCard
  {
    public SpellCard_SSS06_02(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "耀星「白夜永昼之光」";
      else
        this.SC_Name = "耀星「白夜永昼之光」";
    ...
    public override void Shoot()
    {
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St06\\关底Boss\\2符E.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St06\\关底Boss\\2符N.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St06\\关底Boss\\2符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St06\\关底Boss\\2符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St06\\关底Boss\\2符L.mbg";
          break;

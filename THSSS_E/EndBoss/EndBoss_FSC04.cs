...
namespace Shooting
{
  internal class EndBoss_FSC04 : EndBoss_Touhou_Small
  {
    public EndBoss_FSC04(
    ...
    public override void Ctrl()
    {
      ...
      {
        EmitterSaveEnegy3D emitterSaveEnegy3D = new EmitterSaveEnegy3D(this.StageData, OriginalPosition, Color.Purple);
        this.StageData.SoundPlay("se_ch02.wav");
      }
      if (this.Time != this.LifeTime)
        return;
      Boss_Kage02 bossKage02 = new Boss_Kage02(this.StageData);

...
namespace Shooting
{
  internal class EndBoss_FSC03 : EndBoss_Touhou_Small
  {
    public EndBoss_FSC03(
    ...
    public override void Ctrl()
    {
      ...
      if (this.Time != this.LifeTime)
        return;
      Boss_Seiryuu02 bossSeiryuu02 = new Boss_Seiryuu02(this.StageData);

...
namespace Shooting
{
  internal class EndBoss_FSC05 : EndBoss_Touhou_Small
  {
    public EndBoss_FSC05(
    ...
    public override void Ctrl()
    {
      ...
      {
        EmitterSaveEnegy3D emitterSaveEnegy3D = new EmitterSaveEnegy3D(this.StageData, OriginalPosition, Color.Red);
        this.StageData.SoundPlay("se_ch02.wav");
      }
      if (this.Time != this.LifeTime)
        return;
      Boss_Rakukun02 bossRakukun02 = new Boss_Rakukun02(this.StageData);

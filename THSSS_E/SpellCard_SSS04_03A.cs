...
// Type: Shooting.SpellCard_SSS04_03A
...
namespace Shooting
{
  internal class SpellCard_SSS04_03A : BaseSpellCard
  {
    public SpellCard_SSS04_03A(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "阴阳「神鬼一击」";
      else
        this.SC_Name = "阴阳「神鬼一击」";
      ...
      if (this.Time == 150)
      {
        ...
        switch (this.Difficulty)
        {
          case DifficultLevel.Easy:
            FileName = ".\\CS\\St04\\关底Boss\\3符E0.mbg";
            break;
          case DifficultLevel.Normal:
            FileName = ".\\CS\\St04\\关底Boss\\3符N0.mbg";
            break;
          case DifficultLevel.Hard:
            FileName = ".\\CS\\St04\\关底Boss\\3符H0.mbg";
            break;
          case DifficultLevel.Lunatic:
            FileName = ".\\CS\\St04\\关底Boss\\3符L0.mbg";
            break;
          default:
            FileName = ".\\CS\\St04\\关底Boss\\3符U0.mbg";
            break;
        }

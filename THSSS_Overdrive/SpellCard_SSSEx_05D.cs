...
// Type: Shooting.SpellCard_SSSEx_05D
...
namespace Shooting
{
  internal class SpellCard_SSSEx_05D : BaseSpellCard
  {
    public SpellCard_SSSEx_05D(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "净符「月光世界」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\5符3.mbg"));
    }
  }
}

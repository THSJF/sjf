...
// Type: Shooting.SpellCard_SSSEx_02D
...
namespace Shooting
{
  internal class SpellCard_SSSEx_02D : BaseSpellCard
  {
    public SpellCard_SSSEx_02D(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "幽光「幻月蝶」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\2符3.mbg"));
    }
  }
}

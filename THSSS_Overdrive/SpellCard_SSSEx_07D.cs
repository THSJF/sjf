...
// Type: Shooting.SpellCard_SSSEx_07D
...
namespace Shooting
{
  internal class SpellCard_SSSEx_07D : BaseSpellCard
  {
    public SpellCard_SSSEx_07D(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "「雾隐流剑技 ～ 天地银蛇」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\7符3.mbg"));
    }
  }
}

...
// Type: Shooting.Planes.Story.Story_SSS04_01
...
{
  internal class Story_SSS04_01 : BaseStory_SSS
  {
    ...
    public override void Ctrl()
    {
      ...
      {
        this.CharN = new CharacterName(this.StageData, "ename_Kage");
      ...
      {
        this.StageData.ChangeBGM(".\\BGM\\Boss04.wav", 0, 0, (int) byte.MaxValue, 463491, 7541982);
        this.LastTime = this.Time;
      }
      if (this.Time != this.Conv.Count)
        return;
      MusicTitle musicTitle = new MusicTitle(this.StageData, "镜中的幻象", new Point(this.BoundRect.Width, this.BoundRect.Height - 16));

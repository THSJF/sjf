...
// Type: Shooting.SpellCard_SSSEx_01
...
namespace Shooting
{
  internal class SpellCard_SSSEx_01 : BaseSpellCard
  {
    public SpellCard_SSSEx_01(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "青符「东之国度的树叶」";
    ...
    public override void Shoot() {
            ...
            this.Boss.Armon = this.Boss.ArmonArray[0];
            }
      if (this.Time != 100)
        return;
      new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\道中Boss\\1符.mbg")).BossBinding = true;
    }
  }
}

...
// Type: Shooting.SpellCard_SSSEx_08
...
namespace Shooting
{
  internal class SpellCard_SSSEx_08 : BaseSpellCard
  {
    ...
    public override void Shoot() {
            ...
            this.Boss.Armon = this.Boss.ArmonArray[15];
            }
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\8符.mbg"));
    }
  }
}

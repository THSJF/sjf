...
// Type: Shooting.SpellCard_SSS06_04
...
namespace Shooting
{
  internal class SpellCard_SSS06_04 : BaseSpellCard
  {
    public SpellCard_SSS06_04(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "星图「宇宙棋盘」";
      else
        this.SC_Name = "星图「宇宙棋盘」";
    ...
    public override void Shoot() { 
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Easy:
          FileName = ".\\CS\\St06\\关底Boss\\4符E.mbg";
          break;
        case DifficultLevel.Normal:
          FileName = ".\\CS\\St06\\关底Boss\\4符N.mbg";
          break;
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St06\\关底Boss\\4符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St06\\关底Boss\\4符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St06\\关底Boss\\4符L.mbg";
          break;

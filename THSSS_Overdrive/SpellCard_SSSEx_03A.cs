...
// Type: Shooting.SpellCard_SSSEx_03A
...
namespace Shooting
{
  internal class SpellCard_SSSEx_03A : BaseSpellCard
  {
    public SpellCard_SSSEx_03A(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "风切「狂风交错」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\3符0.mbg"));
    }
  }
}

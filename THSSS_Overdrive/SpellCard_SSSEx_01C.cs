...
// Type: Shooting.SpellCard_SSSEx_01C
...
namespace Shooting
{
  internal class SpellCard_SSSEx_01C : BaseSpellCard
  {
    public SpellCard_SSSEx_01C(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "冬临「初雪之寒径」";
      this.BaseScore = 40000000L;
      this.Boss.DestPoint = (PointF) new Point(this.BoundRect.Width / 2, 224);
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\1符2.mbg"));
    }
  }
}

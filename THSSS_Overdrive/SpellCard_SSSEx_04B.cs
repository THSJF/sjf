...
// Type: Shooting.SpellCard_SSSEx_04B
...
namespace Shooting
{
  internal class SpellCard_SSSEx_04B : BaseSpellCard
  {
    public SpellCard_SSSEx_04B(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "荣符「生长与枯萎的循环」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\4符1.mbg"));
    }
  }
}

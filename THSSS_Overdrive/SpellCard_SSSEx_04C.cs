...
// Type: Shooting.SpellCard_SSSEx_04C
...
namespace Shooting
{
  internal class SpellCard_SSSEx_04C : BaseSpellCard
  {
    public SpellCard_SSSEx_04C(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "米雪「冷云雪晶」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\4符2.mbg"));
    }
  }
}

...
// Type: Shooting.SpellCard_SSS04_04C
...
namespace Shooting
{
  internal class SpellCard_SSS04_04C : BaseTimeSC
  {
    public SpellCard_SSS04_04C(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "秘术「遗忘之封印」";
      else
        this.SC_Name = "秘术「遗忘之封印」";
      ...
      if (this.Time == 150)
      {
        ...
        switch (this.Difficulty)
        {
          case DifficultLevel.Easy:
            FileName = ".\\CS\\St04\\关底Boss\\4符E2.mbg";
            break;
          case DifficultLevel.Normal:
            FileName = ".\\CS\\St04\\关底Boss\\4符N2.mbg";
            break;
          case DifficultLevel.Hard:
            FileName = ".\\CS\\St04\\关底Boss\\4符H2.mbg";
            break;
          case DifficultLevel.Lunatic:
            FileName = ".\\CS\\St04\\关底Boss\\4符L2.mbg";
            break;
          default:
            FileName = ".\\CS\\St04\\关底Boss\\4符U2.mbg";
            break;
        }

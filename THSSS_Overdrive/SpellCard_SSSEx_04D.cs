...
// Type: Shooting.SpellCard_SSSEx_04D
...
namespace Shooting
{
  internal class SpellCard_SSSEx_04D : BaseSpellCard
  {
    public SpellCard_SSSEx_04D(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "仙幻「月葬」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\4符3.mbg"));
    }
  }
}

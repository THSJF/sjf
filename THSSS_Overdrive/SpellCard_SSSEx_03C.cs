...
// Type: Shooting.SpellCard_SSSEx_03C
...
namespace Shooting
{
  internal class SpellCard_SSSEx_03C : BaseSpellCard
  {
    public SpellCard_SSSEx_03C(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "霜冻「寒霜封印」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\3符2.mbg"));
    }
  }
}

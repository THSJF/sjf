...
// Type: Shooting.SpellCard_SSSEx_02B
...
namespace Shooting
{
  internal class SpellCard_SSSEx_02B : BaseSpellCard
  {
    public SpellCard_SSSEx_02B(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "幻花「仙晶玉莲」";
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\2符1.mbg"));
    }
  }
}

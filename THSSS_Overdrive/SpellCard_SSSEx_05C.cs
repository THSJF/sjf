...
// Type: Shooting.SpellCard_SSSEx_05C
...
namespace Shooting
{
  internal class SpellCard_SSSEx_05C : BaseSpellCard
  {
    ...
    public override void Shoot() {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\5符2.mbg"));
    }
  }
}

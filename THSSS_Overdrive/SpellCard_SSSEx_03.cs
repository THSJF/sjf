...
// Type: Shooting.SpellCard_SSSEx_03
...
namespace Shooting
{
  internal class SpellCard_SSSEx_03 : BaseSpellCard
  {
    public SpellCard_SSSEx_03(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "蝶恋「千年之愿」";
    ...
    public override void Shoot() {
            ...
            this.Boss.Armon = this.Boss.ArmonArray[2];
            }
      if (this.Time > 50)
        this.Boss.RandomMove(150, 20, 2f, new Rectangle(this.BoundRect.Width / 2 - 45, 100, 90, 40));
      if (this.Time != 100)
        return;
      new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\道中Boss\\3符.mbg")).BossBinding = true;
    }
  }
}

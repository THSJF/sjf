...
// Type: Shooting.SpellCard_SSS03_FSC
...
namespace Shooting
{
  internal class SpellCard_SSS03_FSC : BaseFSC
  {
    public SpellCard_SSS03_FSC(StageDataPackage StageData)
      : base(StageData)
    {
      if (this.Difficulty < DifficultLevel.Hard)
        this.SC_Name = "叶符「德律阿得斯的圣枝」";
      else
        this.SC_Name = "叶符「德律阿得斯的圣枝」";
    ...
    public override void Shoot() { 
      ...
      switch (this.Difficulty)
      {
        case DifficultLevel.Hard:
          FileName = ".\\CS\\St03\\关底Boss\\FSC符H.mbg";
          break;
        case DifficultLevel.Lunatic:
          FileName = ".\\CS\\St03\\关底Boss\\FSC符L.mbg";
          break;
        default:
          FileName = ".\\CS\\St03\\关底Boss\\FSC符L.mbg";
          break;

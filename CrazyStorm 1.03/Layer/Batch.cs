...
namespace CrazyStorm_1._03 {
    ...
    public class Batch {
        ...
        public Batch(float xs,float ys,int pc) {
            rand=new Batch();
            rdirections=new PointF();
            fdirections=new PointF();
            speedds=new PointF();
            aspeedds=new PointF();
            heads=new PointF();
            sonspeedds=new PointF();
            sonaspeedds=new PointF();

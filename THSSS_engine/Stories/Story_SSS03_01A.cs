...
// Type: Shooting.Planes.Story.Story_SSS03_01A
...
{
  internal class Story_SSS03_01A : BaseStory_SSS
  {
    public Story_SSS03_01A(StageDataPackage StageData)
      : base(StageData)
    {
      this.LoadConversation2(".\\Story\\3-1A.csv");
    }

...
// Type: Shooting.ParticleTitleStar
...
namespace Shooting
{
  internal class ParticleTitleStar : BaseBackground
  {
    private int Tran;

    public ParticleTitleStar(
    ...
    public override void Ctrl()
    {
      ...
      if (this.Time == 10)
      {
        ...
        this.Time += this.Ran.Next(20);
      }
      this.Tran = this.TransparentValue + (int) (80.0 * Math.Sin((double) this.Time * 20.0 / 180.0 * Math.PI));
      if (this.Tran < 0)
      {
        this.Tran = 0;
      }

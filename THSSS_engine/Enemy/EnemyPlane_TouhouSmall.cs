...
namespace Shooting {
    internal class EnemyPlane_TouhouSmall:BaseEnemyPlane_Touhou {
        ...
        public EnemyPlane_TouhouSmall(StageDataPackage StageData,string EnemyName,PointF OriginalPosition,float Velocity,double Direction,byte ColorType) : base(StageData,EnemyName,OriginalPosition,Velocity,Direction,ColorType) {
            this.HealthPoint=10f;
            this.ItemCount=1;
        }

        public EnemyPlane_TouhouSmall(StageDataPackage StageData,string EnemyName,PointF OriginalPosition,float Velocity,double Direction) : base(StageData,EnemyName,OriginalPosition,Velocity,Direction) {

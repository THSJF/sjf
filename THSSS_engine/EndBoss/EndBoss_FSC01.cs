...
namespace Shooting
{
  internal class EndBoss_FSC01 : EndBoss_Touhou_Small
  {
    public EndBoss_FSC01(
    ...
    public override void Ctrl()
    {
      ...
      {
        EmitterSaveEnegy3D emitterSaveEnegy3D = new EmitterSaveEnegy3D(this.StageData, OriginalPosition, Color.Yellow);
        this.StageData.SoundPlay("se_ch02.wav");
      }
      if (this.Time != this.LifeTime)
        return;
      Boss_Ami03 bossAmi03 = new Boss_Ami03(this.StageData);

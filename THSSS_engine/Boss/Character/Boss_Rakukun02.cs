...
namespace Shooting
{
  internal class Boss_Rakukun02 : BaseBossTouhou
  {
    public Boss_Rakukun02(StageDataPackage StageData)
      : base(StageData)
    {
    ...
    private void Ctrl1()
    {
      ...
      else
      {
        ...
        if (this.Time == 2)
        {
          SpellCard_SSS05_FSC spellCardSsS05Fsc = new SpellCard_SSS05_FSC(this.StageData);
        }
      }
    }

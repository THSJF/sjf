...
// Type: Shooting.SpellCard_SSSEx_10
...
namespace Shooting
{
  internal class SpellCard_SSSEx_10 : BaseSpellCard
  {
    public SpellCard_SSSEx_10(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "「未定」";
    ...
    {
      this.Boss.Armon = this.Boss.ArmonArray[17];
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\10符.mbg"));
    }
  }
}

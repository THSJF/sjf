...
// Type: Shooting.SpellCard_SSSEx_02A
...
namespace Shooting
{
  internal class SpellCard_SSSEx_02A : BaseSpellCard
  {
    public SpellCard_SSSEx_02A(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "速风「双龙卷」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\2符0.mbg"));
    }
  }
}

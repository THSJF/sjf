...
// Type: Shooting.SpellCard_SSSEx_06D
...
namespace Shooting
{
  internal class SpellCard_SSSEx_06D : BaseSpellCard
  {
    public SpellCard_SSSEx_06D(StageDataPackage StageData)
      : base(StageData)
    {
      this.SC_Name = "皎符「星月炮」";
    ...
    public override void Shoot()
    {
      ...
      if (this.Time != 100)
        return;
      CSEmitterController emitterController = new CSEmitterController(this.StageData, this.StageData.LoadCS(".\\CS\\StEx\\关底Boss\\6符3.mbg"));
    }
  }
}

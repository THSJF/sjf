                ...
                for(int index3 = 0;index3<4;++index3) {
                    ...
                    if(str2.Split(':')[1].Split(',')[0]!="empty") {
                        ...
                        for(int index5 = 0;index5<num5;++index5) {
                            ...
                            baseEmitterCs.EmitRadius=int.Parse(strArray[12]);
                            ...
                            baseEmitterCs.Range=int.Parse(strArray[19]);
                            ...
                            baseEmitterCs.SubBullet.TransparentValueF=int.Parse(strArray[33])*byte.MaxValue/100;
                            ...
                            baseEmitterCs.RanRadius=int.Parse(strArray[55]);
                            ...
                            baseEmitterCs.RanRange=int.Parse(strArray[60]);
                        ...
                        if(str2.Split(':')[1].Split(',').Length>=7) {
                            ...
                            for(int index5 = 0;index5<num7;++index5) {
                                ...
                                baseEmitterCs.StartTime=int.Parse(strArray[8]);
                                baseEmitterCs.Duration=int.Parse(strArray[9]);
                                baseEmitterCs.EmitRadius=int.Parse(strArray[10]);
                                ...
                                baseEmitterCs.Range=int.Parse(strArray[17]);
                                ...
                                if(baseEmitterCs.EmitterMode==EmitterMode.StraightLaser||baseEmitterCs.EmitterMode==EmitterMode.BendLaser) {
                                    ...
                                    baseEmitterCs.SubBullet.MaxScaleW=int.Parse(strArray[27])/256f;
                                ...
                                baseEmitterCs.SubBullet.TransparentValueF=int.Parse(strArray[28])*byte.MaxValue/100;
                                ...
                                while(true) {
                                    if(index6<str4.Split('&').Length-1) {
                                        ...
                                        EventGroup eventGroup = new EventGroup {
                                            index=index6,
                                            tag=str5.Split('|')[0],
                                            t=int.Parse(str5.Split('|')[1]),
                                            addtime=int.Parse(str5.Split('|')[2])
                                        };
                                        int index7 = 0;
                                        while(true) {
                                ...
                                baseEmitterCs.RanRadius=int.Parse(strArray[44]);
                                ...
                                baseEmitterCs.RanRange=int.Parse(strArray[49]);
                                ...
                                if(strArray.Length>58) baseEmitterCs.DeepBinding=bool.Parse(strArray[58]);
                                if(strArray.Length>62) {
                                    ...
                                    if(baseEmitterCs.EmitterMode==EmitterMode.StraightLaser) ((Bullet_StraightLaser)baseEmitterCs.SubBullet).LaserHead=(bool.Parse(str3.Split(',')[62]) ? 1 : 0)!=0;
                                }
                                EmitterList.Add(baseEmitterCs);
                            }
                            ...
                            for(int index5 = 0;index5<num8;++index5) {
                                ...
                                BaseCover_CS baseCoverCs = new BaseCover_CS(StageData) {
                                    ...
                                    LayerID=int.Parse(strArray[1]),
                                    CS_Position=new PointF(float.Parse(strArray[2]),float.Parse(strArray[3])),
                                    StartTime=int.Parse(strArray[4]),
                                    Duration=int.Parse(strArray[5]),
                                    ScaleWidth=int.Parse(strArray[6]),
                                    ScaleLength=int.Parse(strArray[7]),
                                    Roundness=bool.Parse(strArray[8]),
                                    Type=int.Parse(strArray[9]),
                                    CtrlID=int.Parse(strArray[10]),
                                ...
                                while(true) {
                                    if(index6<str3.Split('&').Length-1) {
                                        ...
                                        EventGroup eventGroup = new EventGroup {
                                            index=index6,
                                            tag=str4.Split('|')[0],
                                            t=int.Parse(str4.Split('|')[1]),
                                            addtime=int.Parse(str4.Split('|')[2])
                                        };
                                        int index7 = 0;
                                        while(true) {
                                ...
                                if(strArray.Length>=24) baseCoverCs.BindingID=int.Parse(strArray[23]);
                                if(strArray.Length>=25&&strArray[24]!="") baseCoverCs.DeepBinding=bool.Parse(strArray[24]);

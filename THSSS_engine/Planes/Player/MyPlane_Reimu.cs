...
namespace Shooting {
    public class MyPlane_Reimu:BaseMyPlane_Touhou {
        public MyPlane_Reimu(StageDataPackage StageData,Point OriginalPosition) : base(StageData,OriginalPosition,"Reimu") {
            WeaponType="A";
            SubPlaneList=new List<BaseSubPlane>(){
                 new Shinmyoumaru(StageData,  Position),
                 new SubPlane_Reimu(StageData,  Position),
                 new SubPlane_Reimu(StageData,  Position),
                 new SubPlane_Reimu(StageData,  Position)
             };
            HighSpeed=4.5f;
        ...
        public override void Shoot() {
            if(Time%3==0) {
                ...
                new BaseMyBullet_Touhou(StageData,"ReimuBullet",new PointF(x-7f,y),30f,-1.0*Math.PI/2.0).Damage=14;
                new BaseMyBullet_Touhou(StageData,"ReimuBullet",new PointF(x+7f,y),30f,-1.0*Math.PI/2.0).Damage=14;
            }
            if(Time%4!=0) return;
        ...
        public override void SpellShoot() {
            if(KClass.Key_Shift) {
                Spell_Reimu spellReimu = new Spell_Reimu(StageData);
            } else {
                Spell_Shinmyoumaru spellShinmyoumaru = new Spell_Shinmyoumaru(StageData);
            }
        }
            ...
            if(KClass.Key_Shift) {
                switch(PowerLevel) {
                    ...
                    case 3:
                        ...
                        double num5 = originalPosition2.Y-70.0;
                        PointF pointF3 = new PointF((float)x1,(float)num5);
                        local3=pointF3;
                        ref PointF local4 = ref SubPlanePoint[1];
                        originalPosition2=OriginalPosition;
                        double num6 = originalPosition2.X-24.0;
                        originalPosition2=OriginalPosition;
                        double num7 = originalPosition2.Y-0.0;
                        PointF pointF4 = new PointF((float)num6,(float)num7);
                        local4=pointF4;
                        ref PointF local5 = ref SubPlanePoint[2];
                        originalPosition2=OriginalPosition;
                        double num8 = originalPosition2.X+24.0;
                        originalPosition2=OriginalPosition;
                        double num9 = originalPosition2.Y-0.0;
                        PointF pointF5 = new PointF((float)num8,(float)num9);
                        local5=pointF5;
                        SubPlaneList[0].ShootDirection=-1.0*Math.PI/2.0;
                        SubPlaneList[1].ShootDirection=109.0*Math.PI/72.0;
                        SubPlaneList[2].ShootDirection=107.0*Math.PI/72.0;
                        break;
                    case 4:
                        ref PointF local6 = ref SubPlanePoint[0];
                        double num10 = OriginalPosition.X-0.0;
                        PointF originalPosition3 = OriginalPosition;
                        double num11 = originalPosition3.Y-70.0;
                        PointF pointF6 = new PointF((float)num10,(float)num11);
                        local6=pointF6;
                        ref PointF local7 = ref SubPlanePoint[1];
                        originalPosition3=OriginalPosition;
                        double num12 = originalPosition3.X+0.0;
                        originalPosition3=OriginalPosition;
                        double num13 = originalPosition3.Y-70.0;
                        PointF pointF7 = new PointF((float)num12,(float)num13);
                        local7=pointF7;
                        ref PointF local8 = ref SubPlanePoint[2];
                        originalPosition3=OriginalPosition;
                        double num14 = originalPosition3.X-24.0;
                        originalPosition3=OriginalPosition;
                        double num15 = originalPosition3.Y-0.0;
                        PointF pointF8 = new PointF((float)num14,(float)num15);
                        local8=pointF8;
                        ref PointF local9 = ref SubPlanePoint[3];
                        originalPosition3=OriginalPosition;
                        double num16 = originalPosition3.X+24.0;
                        originalPosition3=OriginalPosition;
                        double num17 = originalPosition3.Y-0.0;
                        PointF pointF9 = new PointF((float)num16,(float)num17);
                        local9=pointF9;
                        SubPlaneList[0].ShootDirection=-1.0*Math.PI/2.0;
                        SubPlaneList[1].ShootDirection=-1.0*Math.PI/2.0;
                        SubPlaneList[2].ShootDirection=109.0*Math.PI/72.0;
                        SubPlaneList[3].ShootDirection=107.0*Math.PI/72.0;
                        break;
                }
            } else {
                switch(PowerLevel) {
                    case 1:
                        SubPlanePoint[0]=new PointF(OriginalPosition.X,OriginalPosition.Y-48f);
                        SubPlaneList[0].ShootDirection=-1.0*Math.PI/2.0;
                        break;
                    case 2:
                        ref PointF local10 = ref SubPlanePoint[0];
                        double num18 = OriginalPosition.X-0.0;
                        PointF originalPosition4 = OriginalPosition;
                        double num19 = originalPosition4.Y-48.0;
                        ...
                        double num20 = originalPosition4.X+0.0;
                        originalPosition4=OriginalPosition;
                        double num21 = originalPosition4.Y+48.0;
                    ...
                    case 3:
                        ...
                        originalPosition5=OriginalPosition;
                        double num25 = originalPosition5.X+48.0;
                        originalPosition5=OriginalPosition;
                    ...
                    case 4:
                        ...
                        originalPosition6=OriginalPosition;
                        double num31 = originalPosition6.X+48.0;
                        originalPosition6=OriginalPosition;
